...
public class TestStudent 
{
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			kb.close();
			System.out.printf("%s\n", student.toString());
			System.out.printf("\nQuiz average: %.2f",student.getAverage());
...
class Student{
	...
	public Student(String name, double score) throws IllegalArgumentException
	{
	...
	public void addQuiz(double grade) 
	{
		...
		else
		{
			...
			this.quizlist += ", Quiz"+numberOfQuizzes+" "+grade;
		}
	}
	public String toString()
	{
		return "Name: "+this.name+this.quizlist;
	}
